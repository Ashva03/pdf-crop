    ...
    <Container>
      <ContentWrapper>
        <PageHeader>
          ...
          <p>Easily convert your JPG & PNG images into a single PDF document</p>
        </PageHeader>
        ...
        <Card>
          <CardContent>
            ...
            {files.length > 0 && (
              <>
                <h3 style={{ fontSize: '1.2rem', marginTop: '2rem', marginBottom: '1rem', color: '#374151' }}>
          ...
          <CardContent>
            ...
            <div style={{ color: '#4b5563', lineHeight: 1.6 }}>
              <p style={{ marginBottom: '1rem' }}>
                Converting your image files to PDF is quick and easy with our tool. Follow these simple steps:
              </p>
              <ol style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
                <li style={{ marginBottom: '0.75rem' }}>
                  <strong>Upload Images</strong> - Drag and drop your JPG or PNG images into the upload area, or click to select files from your device.
                </li>
                <li style={{ marginBottom: '0.75rem' }}>
                  <strong>Arrange Order</strong> - Your images will appear in the order they were selected. To change the order, you can remove and re-add images.
                </li>
                <li style={{ marginBottom: '0.75rem' }}>
                  <strong>Generate PDF</strong> - Click the "Generate PDF" button to convert your images into a single PDF document.
                </li>
                <li style={{ marginBottom: '0.75rem' }}>
                  <strong>Download or Print</strong> - After preview, you can download the PDF to your device or print it directly.
                </li>
              </ol>
              <p>
                This tool processes your images securely in your browser - your files are never uploaded to our servers.
              </p>
            </div>
          </CardContent>
        </Card>
