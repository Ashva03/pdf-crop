    ...
    <Container>
      ...
      <ContentSection>
        <TutorialStep>
          ...
          <p>
            To start cropping your PDF, click and drag on the preview area to
            create a crop rectangle. You can adjust the size and position of the
            crop area by:
          </p>
          <ul>
          ...
          <img
            src="/tutorials/select-crop-area.jpg"
            alt="Selecting Crop Area"
          />
        </TutorialStep>
        ...
        <TutorialStep>
          ...
          <TipBox>
            <h3>Pro Tip</h3>
            <p>
              Hold the Shift key while dragging to maintain the aspect ratio of
              your crop area.
            </p>
          </TipBox>
        </TutorialStep>
        ...
        <NavigationLinks>
          ...
          <Link href="/tutorials/saving-exporting">
            Next: Saving & Exporting →
          </Link>
        </NavigationLinks>
      </ContentSection>
    </Container>
