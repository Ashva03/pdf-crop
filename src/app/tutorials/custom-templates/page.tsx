  ...
  return (
    <Container>
      <HeroSection>
        ...
        <Description>
          Learn how to create and use custom templates to streamline your PDF
          cropping workflow.
        </Description>
      </HeroSection>
      ...
      <ContentSection>
        ...
        <TutorialStep>
          ...
          <TipBox>
            <h3>Pro Tip</h3>
            <p>
              Use descriptive names and tags to make your templates easy to find
              later.
            </p>
          </TipBox>
        </TutorialStep>
        ...
        <NavigationLinks>
          ...
          <Link href="/tutorials/quality-settings">
            Next: Quality Settings →
          </Link>
        </NavigationLinks>
      </ContentSection>
    </Container>
