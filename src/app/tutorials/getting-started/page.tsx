    ...
    <Container>
      ...
      <ContentSection>
        <Step>
          ...
          <p>
            Start by uploading your PDF file. You can either drag and drop your
            file into the upload area or click to browse your files.
          </p>
        ...
        <Step>
          ...
          <p>
            Use the crop tool to select the area you want to keep. You can
            adjust the size and position of the crop area by dragging the
            corners or edges.
          </p>
        ...
        <Step>
          ...
          <p>
            Preview your cropped PDF and make any necessary adjustments. You can
            zoom in/out and pan around to ensure you've selected the perfect
            area.
          </p>
        ...
        <Step>
          ...
          <p>
            Once you're satisfied with the crop, click the download button to
            save your cropped PDF. You can choose to download as PDF or other
            supported formats.
          </p>
