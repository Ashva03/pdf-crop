    ...
    return (
        <Container>
            <HeroSection>
                ...
                <Description>
                    Learn about the different components and features of the PDF Cropper interface.
                </Description>
            </HeroSection>
            ...
            <ContentSection>
                <InterfaceSection>
                    ...
                    <img src="/tutorials/interface-overview.jpg" alt="PDF Cropper Interface" />
                    <FeatureList>
                        <li>Upload Area: Drag and drop or click to upload your PDF files</li>
                        <li>Toolbar: Access cropping tools, zoom controls, and other features</li>
