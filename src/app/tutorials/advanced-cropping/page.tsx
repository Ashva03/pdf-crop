    ...
    <Container>
      ...
      <ContentSection>
        ...
        <TutorialStep>
          ...
          <img
            src="/tutorials/precision-controls.jpg"
            alt="Precision Controls"
          />
          <TipBox>
            <h3>Pro Tip</h3>
            <p>
              Use the Alt key while dragging to temporarily disable snap-to-grid
        ...
        <TutorialStep>
          ...
          <img
            src="/tutorials/multi-page-cropping.jpg"
            alt="Multi-Page Cropping"
          />
        </TutorialStep>
        ...
        <NavigationLinks>
          <Link href="/tutorials/saving-exporting">
            ← Previous: Saving & Exporting
          </Link>
          <Link href="/tutorials/batch-processing">
