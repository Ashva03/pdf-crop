    ...
    <Container>
      ...
      <ContentSection>
        <TutorialStep>
          ...
          <p>
            PDF Cropper supports multiple output formats. Choose the one that
          ...
          <FormatGrid>
            <FormatCard>
              <h3>PDF</h3>
              <p>
                Best for documents, maintains text quality and vector graphics
              </p>
            </FormatCard>
            <FormatCard>
              <h3>PNG</h3>
        ...
        <TutorialStep>
          ...
          <TipBox>
            <h3>Pro Tip</h3>
            <p>
              For printing, always use 300 DPI and CMYK color mode for best
              results.
            </p>
          </TipBox>
        </TutorialStep>
        ...
        <NavigationLinks>
          <Link href="/tutorials/basic-cropping">
            ← Previous: Basic Cropping
          </Link>
          <Link href="/tutorials/advanced-cropping">
            Next: Advanced Cropping →
          </Link>
        </NavigationLinks>
      </ContentSection>
    </Container>
