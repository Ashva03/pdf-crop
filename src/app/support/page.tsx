  ...
  return (
    <Container>
      <HeroSection>
        ...
        <Description>
          We're here to help! Choose from our support options or contact us
          directly.
        </Description>
      </HeroSection>
      ...
      <SupportGrid>
        <SupportCard>
          <h2>Help Center</h2>
          <p>
            Find answers to common questions and learn how to use PDF Cropper
            effectively.
          </p>
          <SupportList>
            <li>
              <SupportLink href="/faq">FAQ</SupportLink>
            </li>
            <li>
              <SupportLink href="/tutorials">Video Tutorials</SupportLink>
            </li>
            <li>
